<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/marchsoft/application/admin/view/marchclass/deletedclass.html";i:1492609856;s:85:"/Applications/XAMPP/xamppfiles/htdocs/marchsoft/application/admin/view/base/base.html";i:1492656039;}*/ ?>
<!DOCTYPE html>
...
<!--                                 <li>
            ...
            <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                ...
                <table id="example-datatable" class="table table-striped table-bordered table-vcenter dataTable no-footer">
                    ...
                    <tr role="row">
                        ...
                        <th tabindex="0" style="width: 100px;">封面</th>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?>
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" data="<?php echo $class['id']; ?>" class="btn btn-primary btn-sm reused">恢复启用</a>
                                <a href="javascript:void(0)" data-toggle="tooltip" class="btn btn-effect-ripple btn-danger btn-sm" style="overflow: hidden; position: relative;" data-original-title="Delete Class"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
    ...
    <script type="text/javascript" src="__JS__/class/deletedClass.js"></script>
